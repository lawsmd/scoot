...
local TEMPLATES = {
    ...
    -- The options panel's search bar: the value box's three pieces with the
    -- magnifying glass and the clear button, the search page's query box
    { label = "SearchBoxTemplate", frameType = "EditBox", template = "SearchBoxTemplate", size = { 200, 20 },
      setup = function(f) f:SetText("Unit Frame") end },
