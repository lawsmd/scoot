...
local function applyPortrait()
    if addon.ApplyUnitFramePortraitFor then
        addon.ApplyUnitFramePortraitFor("FocusTarget")
    end
...
local function buildStyleTab(inner, barPrefix, applyFn, colorValues, colorOrder, colorInfoIcons)
    ...
    inner:AddDualBarStyleRow({
        label = "Foreground",
        getTexture = function() local t = ensureFocusTargetDB() or {}; return t[barPrefix .. "Texture"] or "default" end,
        setTexture = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "Texture"] = v or "default"; applyFn() end end,
        colorValues = colorValues, colorOrder = colorOrder, colorInfoIcons = colorInfoIcons,
        getColorMode = function() local t = ensureFocusTargetDB() or {}; return t[barPrefix .. "ColorMode"] or "default" end,
        setColorMode = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "ColorMode"] = v or "default"; applyFn() end end,
        ...
        setColor = function(r,g,b,a) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "Tint"] = {r or 1, g or 1, b or 1, a or 1}; applyFn() end end,
    ...
    inner:AddDualBarStyleRow({
        label = "Background",
        getTexture = function() local t = ensureFocusTargetDB() or {}; return t[barPrefix .. "BackgroundTexture"] or "default" end,
        setTexture = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BackgroundTexture"] = v or "default"; applyFn() end end,
        colorValues = UF.bgColorValues, colorOrder = UF.bgColorOrder,
        getColorMode = function() local t = ensureFocusTargetDB() or {}; return t[barPrefix .. "BackgroundColorMode"] or "default" end,
        setColorMode = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BackgroundColorMode"] = v or "default"; applyFn() end end,
        getColor = function() local t = ensureFocusTargetDB() or {}; local c = t[barPrefix .. "BackgroundTint"] or {0,0,0,1}; return c[1] or 0, c[2] or 0, c[3] or 0, c[4] or 1 end,
        setColor = function(r,g,b,a) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BackgroundTint"] = {r or 0, g or 0, b or 0, a or 1}; applyFn() end end,
        customColorValue = "custom", hasAlpha = true,
    })
    ...
    inner:AddSlider({
        ...
        get = function() local t = ensureFocusTargetDB() or {}; return tonumber(t[barPrefix .. "BackgroundOpacity"]) or 50 end,
        set = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BackgroundOpacity"] = tonumber(v) or 50; applyFn() end end,
    })
...
local function buildBorderTab(inner, barPrefix, applyFn)
    inner:AddBarBorderSelector({
        label = "Border Style",
        includeNone = true,
        get = function() local t = ensureFocusTargetDB() or {}; return t[barPrefix .. "BorderStyle"] or "square" end,
        set = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BorderStyle"] = v or "square"; applyFn() end end,
    })

    inner:AddToggleColorPicker({
        label = "Border Tint",
        get = function() local t = ensureFocusTargetDB() or {}; return not not t[barPrefix .. "BorderTintEnable"] end,
        set = function(v) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BorderTintEnable"] = not not v; applyFn() end end,
        getColor = function() local t = ensureFocusTargetDB() or {}; local c = t[barPrefix .. "BorderTintColor"] or {1,1,1,1}; return c[1] or 1, c[2] or 1, c[3] or 1, c[4] or 1 end,
        setColor = function(r,g,b,a) local t = ensureFocusTargetDB(); if t then t[barPrefix .. "BorderTintColor"] = {r or 1, g or 1, b or 1, a or 1}; applyFn() end end,
        hasAlpha = true,
    })
    ...
    inner:AddSlider({
        ...
        get = function() local t = ensureFocusTargetDB() or {}; local v = tonumber(t[barPrefix .. "BorderThickness"]) or 1; return math.max(1, math.min(8, math.floor(v * 2 + 0.5) / 2)) end,
                ...
                buildContent = {
                    ...
                    visibility = function(cf, tabInner)
                        tabInner:AddToggle({
                            ...
                            get = function() local t = ensureFocusTargetDB() or {}; return not not t.powerBarHidden end,
                            set = function(v) local t = ensureFocusTargetDB(); if t then t.powerBarHidden = v and true or false; applyPowerVisibility() end end,
                        })
                        tabInner:Finalize()
                    end,
                },
    ...
    builder:AddCollapsibleSection({
        ...
        buildContent = function(contentFrame, inner)
            inner:AddToggle({
                ...
                get = function() local t = ensureFocusTargetDB() or {}; return not not t.nameTextHidden end,
                set = function(v) local t = ensureFocusTargetDB(); if t then t.nameTextHidden = not not v; applyNameText() end end,
            })
