-- CooldownViewersRenderer.lua - Essential and Utility Cooldowns settings renderers
...
local VIEWERS = {
    { componentId = "essentialCooldowns", frameName = "EssentialCooldownViewer" },
    { componentId = "utilityCooldowns", frameName = "UtilityCooldownViewer", hasHideWhenInactive = true },
}

local function CreateRenderer(viewer)
    local COMPONENT_ID = viewer.componentId
    local FRAME_NAME = viewer.frameName
    ...
    local function render(panel, scrollContent)
        ...
        builder:AddCollapsibleSection({
            ...
            buildContent = function(contentFrame, inner)
                ...
                inner:AddToggle({
                    ...
                    set = function(v)
                        ...
                        if addon.RefreshCDMCenterAnchor then
                            addon.RefreshCDMCenterAnchor(COMPONENT_ID)
                        end
                    end,
                })
                ...
                inner:AddSlider({
                    ...
                    debounceKey = "UI_" .. COMPONENT_ID .. "_columns",
                    debounceDelay = 0.2,
                ...
                inner:AddTabbedSection({
                    ...
                    buildContent = {
                        charges = function(tabContent, tabBuilder)
                            ...
                            -- Deep Shadow styles).
                            local s = Helpers.CreateSubTableHelpers(COMPONENT_ID, "textStacks", { apply = applyText })
                        ...
                        cooldowns = function(tabContent, tabBuilder)
                            ...
                            local s = Helpers.CreateSubTableHelpers(COMPONENT_ID, "textCooldown", { apply = applyText })
                            tabBuilder:AddTextStyleBlock({
                                get = s.get, set = s.set, apply = applyText,
                        ...
                        bindings = function(tabContent, tabBuilder)
                            local s = Helpers.CreateSubTableHelpers(COMPONENT_ID, "textBindings", { apply = applyText })
        ...
        builder:AddCollapsibleSection({
            ...
            buildContent = function(contentFrame, inner)
                ...
                inner:AddSelector({
                    ...
                    set = function(v)
                        ...
                        if addon and addon.RefreshCDMCooldownOpacity then
                            addon.RefreshCDMCooldownOpacity(FRAME_NAME, COMPONENT_ID)
                        end
                ...
                inner:AddStateOpacityBlock({
                    ...
                    apply = function()
                        if addon and addon.RefreshCDMViewerOpacity then
                            addon.RefreshCDMViewerOpacity(COMPONENT_ID)
                        end
                    end,
                    -- The combat value is the Edit Mode setting: no refresh, the sync applies.
                    combat = {
                        apply = false,
                        debounceKey = "UI_" .. COMPONENT_ID .. "_opacity",
                        debounceDelay = 0.2,
                ...
                if viewer.hasHideWhenInactive then
                    -- Hide When Inactive toggle (Edit Mode setting)
                    inner:AddToggle({
...
for _, viewer in ipairs(VIEWERS) do
    addon.UI.SettingsPanel:RegisterRenderer(viewer.componentId, CreateRenderer(viewer))
end
