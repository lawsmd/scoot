            ...
            inner:AddTabbedSection({
                ...
                buildContent = {
                    charges = function(tabContent, tabBuilder)
                        ...
                        -- Deep Shadow styles).
                        local s = Helpers.CreateSubTableHelpers("utilityCooldowns", "textStacks", { apply = applyText })
                    ...
                    cooldowns = function(tabContent, tabBuilder)
                        ...
                        local s = Helpers.CreateSubTableHelpers("utilityCooldowns", "textCooldown", { apply = applyText })
                        tabBuilder:AddTextStyleBlock({
                            get = s.get, set = s.set, apply = applyText,
                            size = { min = 6, max = 32, minLabel = "6", maxLabel = "32" },
                        })
                    ...
                    bindings = function(tabContent, tabBuilder)
                        local s = Helpers.CreateSubTableHelpers("utilityCooldowns", "textBindings", { apply = applyText })
