-- viewers.lua - Essential and Utility Cooldowns component definitions
local addonName, addon = ...

local Component = addon.ComponentPrototype

local VIEWERS = {
    { id = "essentialCooldowns", name = "Essential Cooldowns", frameName = "EssentialCooldownViewer" },
    { id = "utilityCooldowns", name = "Utility Cooldowns", frameName = "UtilityCooldownViewer", hideWhenInactive = true },
}

local function buildSettings(viewer)
    local settings = {
    ...
    if viewer.hideWhenInactive then
        settings.hideWhenInactive = { type = "editmode", default = false, ui = {
...
addon:RegisterComponentInitializer(function(self)
    for _, viewer in ipairs(VIEWERS) do
        self:RegisterComponent(Component:New({
            id = viewer.id,
            name = viewer.name,
            frameName = viewer.frameName,
            settings = buildSettings(viewer),
