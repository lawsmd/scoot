...
Presets:Register({
  ...
  systems = {
    ...
    {
      anchorInfo = {
        offsetX = 1050.0999755859,
        offsetY = -826.70001220703,
        point = "TOPLEFT",
        relativePoint = "TOPLEFT",
        relativeTo = "UIParent",
      },
  ...
  components = {
    ...
    essentialCooldowns = {
      ...
      orientation = "H",
      positionY = -222,
      procLoopColor = "rainbow",
      procLoopInsetH = 0,
      procLoopInsetV = 0,
      procLoopSpeed = 15,
      procLoopStyle = "pixelDots",
      showTimer = true,
      showTooltip = true,
      squareCooldownSwipe = false,
      supportsText = true,
      tallWideRatio = -40,
      textBindings = {
        anchor = "BOTTOM",
    ...
    minimapStyle = {
      ...
      coordsColorMode = "default",
      coordsEnabled = true,
      coordsFont = "ROBOTO_SEMICOND_BLACK",
      coordsFontSize = 18,
      coordsFontStyle = "SHADOWTHICKOUTLINE",
      coordsOffsetX = 0,
      coordsOffsetY = -25,
      coordsPosition = "TOP",
...
— Turn in dailies",
    ...
    utilityCooldowns = {
      ...
      positionX = 90,
      positionY = -276,
      procLoopColor = "custom",
      procLoopInsetH = 0,
      procLoopInsetV = 0,
      procLoopSpeed = 25,
      procLoopStyle = "default",
      showTimer = true,
      showTooltip = true,
      squareCooldownSwipe = false,
      supportsText = true,
  ...
  unitFrames = {
    ...
    Player = {
      ...
      castBar = {
        ...
        hideCastFlash = true,
        hideCastShine = true,
        hideChannelSparkles = true,
        hideChannelingShadow = true,
        hideChargeFlash = true,
        hideCompletionFlare = true,
        hideStandardGlow = true,
        hideTextBorder = true,
        hideWispGlow = true,
        spellNameText = {
          colorMode = "specGradient",
          fontFace = "ROBOTO_SEMICOND_BLACK",
          size = 16,
          style = "SHADOWTHICKOUTLINE",
        },
