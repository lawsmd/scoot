...
const PATTERNS = [
  ...
  { name: 'opacity-field', re: /[.:]\s*(opacityInCombat|opacityWithTarget|opacityOutOfCombat|barOpacity|barOpacityOutOfCombat|barOpacityWithTarget)\b/, except: ['core/opacity.lua', 'ui/v2/settings/BuilderComposites.lua'],
    hint: 'Opacity keys are read through addon.Opacity.Resolve, a DeclaresAny or DeclaresSet test, or an Opacity.Keys map. The bare "opacity" key is not greppable; every current hit is a different opacity.' },
  ...
  { name: 'doc-ref', re: /[a-z0-9_&-]+\.md\b|wow-ui-source/i, except: [],
